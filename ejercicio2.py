...
if presupuesto_del_fabricante > 500000:
    inversion_empresa = presupuesto_del_fabricante * 0.55
    prestamo_banco = (presupuesto_del_fabricante - inversion_empresa) * 0.3
    credito_al_fabricante = presupuesto_del_fabricante - inversion_empresa + prestamo_banco
    
    print(f'La empresa puede pagar {inversion_empresa}gs, pidiendo al banco un prestamo de {prestamo_banco}gs y el resto {credito_al_fabricante}gs lo pagara solicitando un credito al fabricante')
...
# Si el monto total de la compra no excede de 500000 la empresa tendrá capacidad de invertir de su propio dinero un 70% y el restante 30% lo pagará solicitando crédito al fabricante. El fabricante cobra por concepto de intereses un 20% sobre la cantidad que se le pague a crédito.
    ...
    inversion_empresa = presupuesto_del_fabricante * 0.7
    credito_al_fabricante = presupuesto_del_fabricante - inversion_empresa

    print(f'La empresa puede pagar {inversion_empresa}gs y el resto {credito_al_fabricante}gs lo pagara solicitando un credito al fabricante')